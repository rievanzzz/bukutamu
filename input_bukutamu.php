...
<body>
    ...
    <table width="90%" border="0" align="center" cellpadding="2" cellspacing="2" class="content">
     ...
     <tr>
        ...
        <td>:</td>
        <td><input name="temail" type="text" id="temail" sixe="30" maxlength="30">
        </td>
     </tr>
     <tr>
     <td valign="midle"><strong>Pesan <span class="style1">*</span></strong></td>
     <td>:</td>
     <td valign="top"><textarea name="tkomentar" cols="5" rows="5" id="tkomentar"></textarea></td>
     </tr>
     <tr>
       <td>&nbsp;</td>
       <td>&nbsp;</td>
